...
namespace Act14_Paginacion
{
    public partial class MainWindow : Form
    {
        ...
        internal async void UpdateLabels(Process p)
        {
            ...
            var qSus = schedule.Suspended;
            lblProRes.Text = qNew.Count.ToString() + ", ";
            susCount.Text = qSus.Count.ToString()+ ", ";
            ...
            if (schedule.Suspended.Count > 0)
            {
                var newTop = qSus.Peek();
                Susdata.Text = newTop.Id.ToString() + " " + newTop.TotalPages.ToString();
            }
        ...
        private void buttonBcp_Click(object sender, EventArgs e)
        {
            schedule.openBCP();
        }
    }
